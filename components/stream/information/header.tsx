  ...
  return (
    <>
      ...
      >
                ...
                >
                  <div
                    style={
                      {
                        "--color-accent":
                          channel?.themeColor ?? "hsl(12 100% 63%)",
                  ...
                  <div className={styles["metadata-layout__support"]}>
                    <div className={styles["channel-name-wrapper"]}>
                      <div className={styles["channel-name-container"]}>
                        ...
                        <div
                          className={
                            styles["verified-partner-indicator-wrapper"]
                          }
                        >
                          <div
                            className={
                    ...
                    <div className={styles["channel-action-wrapper"]}>
                      <div className={styles["channel-action-container"]}>
                        <div className={styles["channel-action-overlay"]}>
                          <div
                            className={styles["follow-button-layout-wrapper"]}
                          >
                            <div
                              className={
                                styles["follow-button-layout-container"]
                              }
                            >
                              <div
                                className={
                                  styles["follow-button-layout-overlay"]
                                }
                                style={{
                                  opacity: "1",
                              ...
                              >
                                ...
                                >
                                  <div
                                    className={styles["follow-button-wrapper"]}
                                  >
                                    <div
                                      className={
                                    ...
                                    >
                                      <div
                                        className={
                                          styles["follow-button-overlay"]
                                        }
                                      >
                                        <div
                                          className={
                                            styles["follow-icon-wrapper"]
                                          }
                                          style={{
                                            opacity: "1",
                                            transition:
                      ...
                      <div className={styles["live-info-overlay"]}>
                        ...
                        <div className={styles["stream-game-wrapper"]}>
                          <div className={styles["stream-game-container"]}>
                            <Link
                              href={"/"}
                              className={styles["stream-game-link"]}
                            >
                          ...
                          <div className={styles["stream-game-tags-wrapper"]}>
                            <div
                              className={styles["stream-game-tags-container"]}
                            >
        ...
        {isFetching && (
          <div className={styles["channel-ino-loading-wrapper"]}>
            <div className={styles["channel-info-loading"]}></div>
          </div>
        )}
      </section>
