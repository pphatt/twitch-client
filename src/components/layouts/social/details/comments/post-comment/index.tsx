...
import styles from "@/components/layouts/social/details/comments/post-comment/style.module.scss"
...
export default function PostComment({
  ...
  return (
    <>
      <div className={styles["user-comment-header-wrapper"]}>
        <Link
          href={`/social/profile/${user.username}`}
          className="comment-avatar-link"
        >
          <div className={styles["comment-avatar-link-wrapper"]}>
            <img
        ...
        <div className={styles["comment-username-wrapper"]}>
          <Link
            href={`/social/profile/${user.username}`}
            className={styles["comment-username-container"]}
          >
      ...
      <div className={styles["comment-content-text-wrapper"]}>
        <div className={styles["comment-content-text-container"]}>
          <div className={styles["comment-content-text-overlay"]}>
