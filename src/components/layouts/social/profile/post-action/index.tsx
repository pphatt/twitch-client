...
import styles from "@/components/layouts/social/profile/post-action/style.module.scss"
...
export default function PostAction({ postId, validateData }: PostActionProps) {
