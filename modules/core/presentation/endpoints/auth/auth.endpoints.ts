...
export const ResetPasswordAPI = `${BackendURL}/auth/reset-password` // {ResetPasswordAPI}/{token}
// export const LogoutFromAllDeviceAPI = `${BackendURL}/auth/logout-from-all-device`
export const LogoutAPI = `${BackendURL}/auth/logout`
// export const LogoutFromSpecificDeviceAPI = `${BackendURL}/auth/logout` // {LogoutFromSpecificDeviceAPI}/{deviceId}
