...
export interface ISocialRepository {
  ...
  unFriend: (body: UnfriendRequestDto) => Promise<void>

  acceptFriend: (body: AcceptFriendRequestDto) => Promise<void>
  rejectFriend: (body: RejectFriendRequestDto) => Promise<void>
}
